        ...
        switch (currentArticle) {
                    ...
                    >
                        <section className=' flex sm:flex-row flex-col sm:justify-evenly  items-center '>
                            <div className='relative z-10'>
                                <section className='relative w-full  animate1'>
                                    <Image src={lifewhy1big} alt='' className='w-full rounded-xl drop-shadow-xl ' />
                                    <h1 className='absolute bottom-20 left-20 text-white text-xl '>Festivels</h1>
                                </section>

                            </div>
                            <Image src={lifewhy2small} alt='' className=' rounded-xl drop-shadow-xl sm:mt-16' />
                            <Image src={lifewhy3small} alt='' className=' rounded-xl drop-shadow-xl sm:mt-16' />
                        </section>
                    </article>
                )
                ...
                return (
                    ...
                    >
                        <div className='absolute -translate-x-1/2 left-[50%] key2 z-10'>
                            <Image src={lifewhy2big} alt='' className='w-full rounded-xl drop-shadow-xl' />
                            <h1 className='absolute bottom-20 left-20 text-white text-xl '>Trips</h1>
                        </div>
                        <section className='flex sm:flex-row flex-col sm:justify-evenly sm:gap-0 items-center'>
                            <Image src={lifewhy1small} alt='' className=' rounded-xl drop-shadow-xl sm:mt-16' />
                            <Image src={lifewhy3small} alt='' className=' rounded-xl drop-shadow-xl sm:mt-16' />
                        </section>
                    </article>
                )
            case 3:
                ...
                return (
                    ...
                    >
                        <div className=''>
                            <div className='absolute -translate-x-1/2 -right-20 animate3 z-10'>
                                <Image src={lifewhy3big} alt='' className='w-full rounded-xl drop-shadow-xl' />
                                <h1 className='absolute bottom-20 left-20 text-white text-xl '>Celebrations</h1>
                            </div>
