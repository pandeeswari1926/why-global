    ...
    <div className='w-full relative overflow-hidden py-5 bg-gray-00'>
      ...
      <div className='flex flex-col lg:flex-row md:px-10 md:gap-[2%] justify-center items-center '>
        ...
        <div className='flex flex-col items-center text-center md:mt-[80px]'>
          <div className='bg-white shadow-orange-200 rounded-full p-8  md:shadow-2xl shadow-lg   transition-transform transform hover:scale-110 hover:bg-orange-500 '>
        ...
        <div className='flex flex-col items-center md:md:-mt-10 text-center'>
          ...
          <p className='text-base font-semibold md:mt-9 mt-4 text-gray-800'>Qualified Professionals</p>
        </div>
        ...
        <div className='flex flex-col items-center md:-mt-10 text-center'>
          ...
          <p className='text-base font-semibold md:mt-9 mt-4 text-gray-800'>Client-Centric Approach</p>
        </div>
        <div className='flex flex-col items-center text-center md:mt-[80px]'>
          <div className='bg-white shadow-orange-200 rounded-full p-8  md:shadow-2xl shadow-lg  transition-transform transform hover:scale-110 hover:bg-orange-500 '>
        ...
        <div className='flex flex-col items-center  text-center md:mt-7'>
          ...
          <p className='text-base font-semibold md:mt-9 mt-4 text-gray-800'>Software Updates</p>
        </div>
        ...
        <div className='flex flex-col items-center text-center md:-mt-12'>
          ...
          <p className='text-base font-semibold md:mt-9 mt-4 text-gray-800'>Annual Maintenance</p>
        </div>
        ...
        <div className='flex flex-col items-center text-center md:-mt-12'>
          ...
          <p className='text-base font-semibold md:mt-9 mt-4 text-gray-800'>Security Audit</p>
        </div>
        <div className='flex flex-col items-center text-center '>
          <div className='bg-white shadow-orange-200 rounded-full p-8  md:shadow-2xl shadow-lg  transition-transform transform hover:scale-110 hover:bg-orange-500'>
