...
function WhyChooseUs() {
  return (
    <div className='w-full relative overflow-hidden py-5 bg-gray-00'>
      <img src='/ply.png' className='lg:w-44 w-36 -bottom-5 -left-20 absolute' alt="Decoration" />
      <img src='/poly.png' className='lg:w-52 w-32 -top-20 -right-5 absolute' alt="Decoration" />

      <div className='md:py-5 md:pl-10  text-center'>
        <h2 className='text-3xl md:text-5xl font-bold text-primary flex items-center justify-center'>
      ...
      <div className='flex flex-col lg:flex-row md:px-10 md:gap-[2%] justify-center items-center '>
        ...
        <img src='/Whychooseusimg1.png' className='w-12 h-12 transition-colors duration-300 hover:filter hover:brightness-0 hover:invert' alt="Qualified Professionals" />
          ...
          <p className='text-base font-semibold mt-9 text-gray-800'>13+ Years of Expertise</p>
        </div>
        ...
        <div className='flex flex-col items-center text-center md:mt-[80px]'>
          ...
          <p className='text-base font-semibold mt-9 text-gray-800'>Proven Track Record</p>
        </div>

        <div className='flex flex-col items-center -mt-10 text-center'>
          <div className='bg-white shadow-orange-200 rounded-full p-8  shadow-2xl transition-transform transform hover:scale-110 hover:bg-orange-500'>
            <img src='/Whychooseusimg3.png' className='w-12 h-12 transition-colors duration-300 hover:filter hover:brightness-0 hover:invert' alt="Qualified Professionals" />
          </div>
          <p className='text-base font-semibold mt-9 text-gray-800'>Qualified Professionals</p>
        </div>
        ...
        <div className='flex flex-col md:mt-12 lg:flex-row md:px-10 md:gap-[2%] justify-center items-center'>
        <div className='flex flex-col items-center text-center md:-mt-12'>
          <div className='bg-white shadow-orange-200 rounded-full p-8  shadow-2xl transition-transform transform hover:scale-110 hover:bg-orange-500'>
            <img src='/Whychooseusimg8.png' className='w-12 h-12 transition-colors duration-300 hover:filter hover:brightness-0 hover:invert' alt="24/7 Help Desk" />
          </div>
          <p className='text-base font-semibold mt-9 text-gray-800'>24/7 Help Desk</p>
        </div>

        <div className='flex flex-col items-center  text-center md:mt-7'>
          <div className='bg-white shadow-orange-200 rounded-full p-8  shadow-2xl transition-transform transform hover:scale-110 hover:bg-orange-500'>
            <img src='/Whychooseusimg9.png' className='w-12 h-12 transition-colors duration-300 hover:filter hover:brightness-0 hover:invert' alt="Software Updates" />
          </div>
          <p className='text-base font-semibold md:mt-9 text-gray-800'>Software Updates</p>
        </div>

        <div className='flex flex-col items-center text-center md:-mt-12'>
          <div className='bg-white shadow-orange-200 rounded-full p-8  shadow-2xl transition-transform transform hover:scale-110 hover:bg-orange-500'>
            <img src='/Whychooseusimg10.png' className='w-12 h-12 transition-colors duration-300 hover:filter hover:brightness-0 hover:invert' alt="Annual Maintenance" />
          </div>
          <p className='text-base font-semibold mt-9 text-gray-800'>Annual Maintenance</p>
        </div>
