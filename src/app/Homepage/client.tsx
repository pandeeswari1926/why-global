...
function Client() {
  return (
    <div className="flex flex-col md:items-start items-center justify-center gap-5 relative">
      <h1 className="font-bold text-xl lg:text-2xl text-[#FF8900] md:px-10 pt-10">
        OUR CLIENTS
      </h1>
