    ...
    <>
      <div className="">
        ...
        <div className="h-screen  w-full relative">
          ...
          <h1 className=" md:text-5xl text-3xl absolute md:top-48 top-48 text-white md:right-20 right-3 text-right font-bold">
            Powerful Digital Solutions
          </h1>
          <p className="md:text-5xl text-3xl md:top-36 top-32 md:right-20 right-3 absolute text-white text-right font-bold">
            For <span className="text-[#FF9315]">Millions</span> of Users
          </p>
        </div>
        <div className="lg:-mt-20 w-full flex lg:flex-row lg:mb-20 mb-5 flex-col justify-center items-center h-fit">
          <div className="flex lg:flex-row flex-col w-full lg:w-[50%] justify-center items-center gap-6 ">
            ...
            <div className="bg-white  outline outline-[#FF9315] relative w-[60%] h-52 lg:w-40  lg:h-44 md:w-[40%]  rounded-3xl drop-shadow-lg flex flex-col justify-center gap-3 items-center">
              ...
              <p className=" text-xl md:text-lg text-wrap w-[80%] text-center ">
                Business Security
              </p>
            </div>
            <div className="bg-white  outline outline-[#FF9315] relative w-[60%] h-52 lg:w-40  lg:h-44 md:w-[40%]  rounded-3xl drop-shadow-lg flex flex-col justify-center gap-3 items-center">
              <FaLaptop className="sm:size-16 size-24  text-[#FF9315]" />
              <p className=" text-xl md:text-lg w-[80%] text-center ">
                Managed IT Services
              </p>
            </div>
          ...
          <div className="mt-10 lg:w-[50%] w-full text-center p-3">
            <p className="">
              Join our team We are looking for talented & driven people to come
        ...
        <div className="lg:grid grid grid-cols-1 lg:grid-cols-2 ">
          ...
          <div className="flex flex-col gap-8 w-[100%] lg:p-10 p-5 text-center md:h-[60%]">
            ...
            <p className="text-md text-gray-500 w-full text-center lg:text-start">
              On the other hand we denounce with righteous indignation hill and
            ...
            <div className="flex lg:flex-row flex-col justify-around items-center px-5 text-gray-500 ">
              <div>
                <div className="flex justify-center items-center leading-loose">
                  <div className="">
                    <Image alt="" src={tick}></Image>
                  </div>{" "}
                  <p className="text-xs"> Cost of supplies and equipment</p>
                </div>
                <div className="flex justify-center items-center leading-loose">
                  <div className="">
                    <Image alt="" src={tick}></Image>
            ...
            <p className="md:text-md text-sm text-justify lg:text-start">
              ...
              lorem quis bibend um auctor nisi elit consequat ipsum.On the other
              hand we denounce with righteous indignation hill and dislike men
              who are so beguiled
            </p>
          </div>
        </div>
