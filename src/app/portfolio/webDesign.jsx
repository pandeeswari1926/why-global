    ...
    return (
        <>
            <div className='m-10 md:pl-20 pl-5 grid md:grid-cols-2 grid-cols-1'>
                <div className='space-y-5 font-sans md:w-[87%] ml-auto'>
