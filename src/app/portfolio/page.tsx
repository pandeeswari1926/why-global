                    ...
                    <div className=''>
                        <div>
                            <div className='flex md:flex-row flex-col justify-center '>
                                <div className='md:w-96 w-full relative top-20 md:-left-20 md:mx-0 mx-20'>
                                ...
                                <div className='md:w-96 w-full relative md:left-64 md:top-20 top-28 md:mx-0 mx-10'>
                            ...
                            <div className='flex md:flex-row flex-col justify-evenly items-center pb-20 '>
                                <div className='md:w-96 w-full relative md:top-32 top-36 md:ml-0 ml-40'>
                                ...
                                <div className='md:w-[500px] w-full relative md:mt-24 mt-44  ml-20'>
                                    ...
                                    <Image src={message4} alt='' className='absolute w-[50%] -mt-28 md:left-72 ml-32' />
                                </div>
                                <div className='md:w-96 w-full relative md:left-36 md:top-32 top-14 md:ml-0 ml-20'>
