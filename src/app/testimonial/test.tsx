  ...
  return (
    <>
      {employee.map((item: EmployeeReview, ind: number) => (
        <div key={ind} className=" md:pl-20 pl-5">
          <div className="bg-test text-center bg-cover w-full h-full  lg:mt-14  mt-28">
            <div className="w-full h-full flex md:flex-row flex-col md:p-0 p-10 justify-between">
              <div className="md:w-[55%] w-full space-y-10 flex flex-col justify-center items-center">
                ...
                <p className="md:w-[45%] w-full text-justify md:text-start">
                  {item?.content}
                </p>
              ...
              <div className="md:w-[45%] w-full flex md:flex-col flex-col-reverse justify-between gap-2  items-center ">
                <div className="flex flex-col ml-0  md:ml-20   ">
                  <h1 className="font-semiboldt text-base xs:text-lg  text-gray-600">
                    {item?.name}
                  </h1>
                  <p className="text-gray-500 md:text-start text-sm ">{item?.role}</p>
                </div>
                <div className="w-[70%] ">
