        ...
        <>
            ...
            <section className='px-[5%] grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 justify-between gap-5 bg-black text-white'>
                ...
                <section className='flex flex-col gap-4'>
                    ...
                    <p className='text-xs sm:text-base leading-6'>We designed a culture that allows our stewards to assimilate with our clients and bring our best</p>
                </section>
                ...
                <section className='flex flex-col gap-4'>
                    ...
                    <section className='text-xs sm:text-base flex gap-3'>
                        ...
                        <p className='-mt-1 text-xs sm:text-base leading-5'>Managed IT Slots</p>
                    </section>
                    <section className='text-xs sm:text-base flex gap-3'>
                        <FontAwesomeIcon icon={faArrowRight} />
                        <p className='-mt-1 text-xs sm:text-base leading-5'>IT Consultancy</p>
                    </section>
                    <section className='text-xs sm:text-base flex gap-3'>
                        <FontAwesomeIcon icon={faArrowRight} />
                        <p className='-mt-1 text-xs sm:text-base leading-5'>Business Solutions</p>
                    </section>
                    <section className='text-xs sm:text-base flex gap-3'>
                        <FontAwesomeIcon icon={faArrowRight} />
                        <p className='-mt-1 text-xs sm:text-base leading-5'>Digital Sevices</p>
                    </section>
                    <section className='text-xs sm:text-base flex gap-3'>
                        <FontAwesomeIcon icon={faArrowRight} />
                ...
                <section className='flex flex-col gap-4 pb-5'>
                    ...
                    <section className='flex gap-2'>
                        ...
                        <p className='-mt-1 text-xs sm:text-base leading-5'>3rd Floor, New No. 75,77 & 79, Lohmanradhri Towers, Egmore, Chennai, Tamil Nadu 60008</p>
                    </section>
                    <section className='flex gap-2'>
                        <FontAwesomeIcon icon={faMailBulk} />
                        <p className='-mt-1 text-xs sm:text-base leading-5 whitespace-nowrap overflow-hidden text-ellipsis'>contact@whyglobalservices.com</p>
                    </section>
                    <section className='flex gap-2'>
                        <FontAwesomeIcon icon={faMobile} />
                        <p className='-mt-1 text-xs sm:text-base leading-5'>+91-82700 99990</p>
                    </section>
